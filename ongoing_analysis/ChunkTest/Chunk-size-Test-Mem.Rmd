...
```{r}
mem_table <- read.csv("/Users/April30/benchmark-hdf5-clustering/ongoing_analysis/ChunkTest/TENxBrainData/Output/mem_best.csv", header=TRUE, sep=",")
...
p_mem <- mem_table %>% 
  ...
  ggplot(aes(x = geometry, y = memory/1024)) +
          geom_point()+
