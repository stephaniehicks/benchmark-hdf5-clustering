...
```{r}
time_table <- read.csv("/Users/April30/benchmark-hdf5-clustering/ongoing_analysis/ChunkTest/TENxBrainData/Output/time.csv", header=TRUE, sep=",")
...
p_time <- time_table %>% 
  ...
  ggplot(aes(x = geometry, y = time1/60, color = label)) +
          geom_point()+
