...
Rprof(filename = here("ongoing_analysis/Mem&Time/data", paste0(now, "_500k_old", ".out")), append = FALSE, memory.profiling = TRUE)
...
profile <- summaryRprof(filename = here("ongoing_analysis/Mem&Time/data", paste0(now, "_500k_old", ".out")), chunksize = -1L, 
