...
heatmap(table(sce$mbk_15, clust), ylab="mbkmeans (k=15)", xlab="Louvain", scale="none")
...
```{r compare_scanpy}
heatmap(table(df$mbk_15, df$leiden), ylab="mbkmeans (k=15)", xlab="Leiden (scanpy)", scale="none")
