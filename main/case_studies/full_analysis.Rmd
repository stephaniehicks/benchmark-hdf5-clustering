...
if(!file.exists(here("main/case_studies/data/full/TENxBrainData/SingleR_Allen_10X_V2_labels_full.rds"))) {
...
#  }
  ...
  pred <- SingleR(test=sce, ref=allen_pseudo,
  ...
  saveRDS(pred, file = here("main/case_studies/data/full/TENxBrainData/SingleR_Allen_10X_V2_labels_full.rds"))
} else {
  readRDS(file = here("main/case_studies/data/full/TENxBrainData/SingleR_Allen_10X_V2_labels.rds"))
}
print(pred)
```
