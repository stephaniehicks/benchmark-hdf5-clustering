...
This currently loads in results from only Ruoxi. Need to add Davide's output. 
...
```{r}
mem_table <- read.csv(here("ongoing_analysis/ChunkTest/TENxBrainData/Output/mem_ruoxi_cluster.csv"), header=TRUE, sep=",")
time_table <- read.csv(here("ongoing_analysis/ChunkTest/TENxBrainData/Output/time_ruoxi_cluster.csv"), header=TRUE, sep=",")
```
