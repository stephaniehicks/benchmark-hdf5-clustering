...
This loads in results from both Ruoxi and Davide. 
...
#> table(acc_real_table_abs_davide$observations)
#   5000 10000 25000 
#   350   350   350 
...
acc_real_table_abs <- 
  cbind(rbind(acc_real_table_abs_davide, acc_real_table_abs_ruoxi), 
