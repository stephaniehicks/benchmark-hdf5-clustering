...
ari_output_bs_0001 <- bench_accuracy_calculate_ari(save_bs_0001)
...
# calculate adjusted Rand Index 
ari_output_bs_0005 <- bench_accuracy_calculate_ari(save_bs_0005)
...
# calculate adjusted Rand Index 
ari_output_bs_001 <- bench_accuracy_calculate_ari(save_bs_001)
...
# calculate adjusted Rand Index 
ari_output_bs_005 <- bench_accuracy_calculate_ari(save_bs_005)
...
# calculate adjusted Rand Index 
ari_output_bs_025 <- bench_accuracy_calculate_ari(save_bs_025)
...
# calculate adjusted Rand Index 
ari_output_bs_050 <- bench_accuracy_calculate_ari(save_bs_050)
...
p_out <- plot_grid(p_bs_0001, p_bs_0005, p_bs_001, 
                   p_bs_005, p_bs_025, p_bs_050, ncol = 3, 
