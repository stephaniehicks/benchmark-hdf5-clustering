...
air_total <- as.data.frame(read.table(here("simulation-studies", 
                                           "Simulation_2019-05-06_12-26-00", "ARI_Summary.txt"),
                                      header = TRUE))

wcss_total <- as.data.frame(read.table(here("simulation-studies", 
                                            "Simulation_2019-05-06_12-26-00", "WCSS_Summary.txt"),
                                       header = TRUE))

time_total <- as.data.frame(read.table(here("simulation-studies", 
                                            "Simulation_2019-05-06_12-26-00","Time_Summary.txt"),
                                       header = TRUE))
